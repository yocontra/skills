...
description: |
  Guide to hardware-accelerated AI inference on Android.
  Use when deploying models with ExecuTorch, QNN, MediaTek NeuroPilot,
  Samsung Exynos NPU, LiteRT, ONNX Runtime Mobile, or Gemini Nano.
  Covers NPU delegation, quantization for mobile backends, JNI bridge patterns,
  fallback strategies, and profiling.
---
